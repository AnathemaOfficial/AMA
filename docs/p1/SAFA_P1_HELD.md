...
P1 hardens SAFA for **concurrent multi-agent use on a single localhost node**.
...
- Documented in `SAFA_CONCURRENCY_MODEL.md`
...
3. **OpenClaw adapter**: Ana → SAFA integration

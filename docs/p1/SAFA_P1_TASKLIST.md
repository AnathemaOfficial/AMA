...
This document translates `SAFA_P1_PLAN.md` into an execution order.
...
- [x] Create `docs/SAFA_IDEMPOTENCY_STATE_MACHINE.md`
...
- [x] Create `docs/SAFA_CONCURRENCY_MODEL.md`
...
- [x] Create `docs/SAFA_QUEUE_MODEL.md`
...
- [ ] Create `docs/SAFA_RATE_LIMIT_MODEL.md` (deferred — fix is simple enough to document inline)
...
- [x] Create `docs/SAFA_TIMEOUTS.md`
...
- [x] `docs/SAFA_P1_PLAN.md`
- [x] `docs/SAFA_P1_TASKLIST.md`
- [x] `docs/SAFA_IDEMPOTENCY_STATE_MACHINE.md`
- [x] `docs/SAFA_CONCURRENCY_MODEL.md`

### Phase B — tests first

- [x] idempotency failing tests (`tests/p1_idempotency.rs` — 8 tests)
- [x] budget race failing tests — already correct (CAS loop), documented in SAFA_CONCURRENCY_MODEL.md
...
**Step 1**: Write `SAFA_IDEMPOTENCY_STATE_MACHINE.md`
...
P1 is the phase where SAFA stops being merely successful in practice and becomes correct by construction under local concurrency.
